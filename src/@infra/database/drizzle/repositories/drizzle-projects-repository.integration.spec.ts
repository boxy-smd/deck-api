      ...
      await db.insert(schema.trails).values([
        {
          ...
          name: trail1.name,
          color: trail1.color,
          lightColor: trail1.lightColor,
          darkColor: trail1.darkColor,
          icon: trail1.icon,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          name: trail2.name,
          color: trail2.color,
          lightColor: trail2.lightColor,
          darkColor: trail2.darkColor,
          icon: trail2.icon,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
    ...
    it('should update project trails', async () => {
      ...
      await db.insert(schema.trails).values([
        ...
        },
        {
          ...
          name: trail3.name,
          color: trail3.color,
          lightColor: trail3.lightColor,
          darkColor: trail3.darkColor,
          icon: trail3.icon,
          createdAt: new Date(),
          updatedAt: new Date(),
        },
