...
describe('DrizzleProjectsRepository (Integration)', () => {
  ...
  describe('create()', () => {
    ...
    it('should create project with trails', async () => {
      ...
      await db.insert(schema.trails).values([
        { id: trail1.id.toString(), name: trail1.name, createdAt: new Date(), updatedAt: new Date() },
        { id: trail2.id.toString(), name: trail2.name, createdAt: new Date(), updatedAt: new Date() },
      ])
    ...
    it('should create project with professors', async () => {
      ...
      await db.insert(schema.professors).values([
        { id: prof1.id.toString(), name: prof1.name, createdAt: new Date(), updatedAt: new Date() },
        { id: prof2.id.toString(), name: prof2.name, createdAt: new Date(), updatedAt: new Date() },
      ])
  ...
  describe('findAll()', () => {
    ...
    it('should return all projects ordered by creation date', async () => {
      ...
      const project1 = makeProject({ title: 'Project 1', authorId: author.id, trails: new Set(), professors: new Set() })
      const project2 = makeProject({ title: 'Project 2', authorId: author.id, trails: new Set(), professors: new Set() })
      const project3 = makeProject({ title: 'Project 3', authorId: author.id, trails: new Set(), professors: new Set() })
  ...
  describe('save()', () => {
    ...
    it('should update project trails', async () => {
      ...
      await db.insert(schema.trails).values([
        { id: trail1.id.toString(), name: trail1.name, createdAt: new Date(), updatedAt: new Date() },
        { id: trail2.id.toString(), name: trail2.name, createdAt: new Date(), updatedAt: new Date() },
        { id: trail3.id.toString(), name: trail3.name, createdAt: new Date(), updatedAt: new Date() },
      ])
