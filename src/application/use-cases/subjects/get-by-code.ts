import type { GetSubjectByCodeUseCaseResponse } from '@/application/dtos/subjects/get-by-code-dtos.ts'
...
export class GetSubjectByCodeUseCase {
  ...
  async execute(code: string): Promise<GetSubjectByCodeUseCaseResponse> {
